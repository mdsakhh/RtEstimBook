...
We take several steps to simulate how cases spread from one person to another: 

1. We simulate each of the distributions above
4. Then, we simulate the population-level infectivity dynamics, i.e., $R(t)$ which include things at the population level (like mask mandates or lockdowns).

<div style="border: 2px dotted black; border-radius: 15px;padding: 5px; background-color: lightyellow;">
<h3 style="margin-top: 5px; font-size: 1.25em;">Modeling $R(t)$</h3>
...
This figure describes various key terms in a infectious disease outbreak:
...
With these number of initial cases, and the distributions defined above, we can observe the timing of the first generation of daily infections, disease onsets, and administrative reports. Notice the differences in the distributions!
